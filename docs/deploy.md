...
- デプロイ後の URL: `https://sf6-sensei-mcp.msnsgw.workers.dev`

### 5. 動作確認

```sh
curl https://sf6-sensei-mcp.msnsgw.workers.dev/health   # => {"status":"ok"}
```
...
- カスタム MCP コネクタを追加し、URL に
  `https://sf6-sensei-mcp.msnsgw.workers.dev/` を指定
